...
if generate_btn:
    ...
    try:
        ...
        # 定义工作流路径
        default_workflow_path = r"J:\Ai_visual_processing_tools\其他\comfyui\工作流\wan2.2i2v_首尾帧.json"
        end_frame_only_workflow_path = r"J:\Ai_visual_processing_tools\其他\comfyui\工作流\wan2.2i2v_尾帧.json"
